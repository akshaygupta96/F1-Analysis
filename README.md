...
2. The second part of the analysis, we look at the average position for both the sprint and race. We want to compare and see the finishing position of the drivers, to see if there are any noticeable differences, especially amongst the mid-tier drivers.
